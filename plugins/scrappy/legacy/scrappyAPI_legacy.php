...
function get_corrected_name($item) {
  ...
  $query = $query_url . 'method=track.getCorrection&api_key='.SCRAPPY_LASTFM_API_KEY.'&format=json&artist='.urlencode(str_replace(' & ', ' and ', $item['artist'])).'&track='.urlencode($item['title']); 
